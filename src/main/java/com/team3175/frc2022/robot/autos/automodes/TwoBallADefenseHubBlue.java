...
public class TwoBallADefenseHubBlue extends SequentialCommandGroup {
    ...
    public TwoBallADefenseHubBlue(Shooter shooter, Feeder feeder, Intake intake, Actuators actuators, SwerveDrivetrain drivetrain) {
        ...
        m_initialPose = new Pose2d(7.10, 4.61, Rotation2d.fromDegrees(-20.56));

        m_intakeA = PathPlanner.loadPath("2BallA-Defense-Hub-1-Blue", Constants.AUTO_MAX_SPEED, Constants.AUTO_MAX_ACCELERATION_MPS_SQUARED);
        m_shootA = PathPlanner.loadPath("2BallA-Defense-Hub-2-Blue", Constants.AUTO_MAX_SPEED, Constants.AUTO_MAX_ACCELERATION_MPS_SQUARED);
        m_intakeOpposite = PathPlanner.loadPath("2BallA-Defense-Hub-3-Blue", Constants.AUTO_MAX_SPEED, Constants.AUTO_MAX_ACCELERATION_MPS_SQUARED);
        m_driveToHangar = PathPlanner.loadPath("2BallA-Defense-Hub-4-Blue", Constants.AUTO_MAX_SPEED, Constants.AUTO_MAX_ACCELERATION_MPS_SQUARED);
        ...
        AutonShootAndFeed m_shootAndFeed2 = new AutonShootAndFeed(m_shooter, m_feeder, Constants.FEEDER_TICKS, Constants.SHOOTER_TARGET_RPM, Constants.FEEDER_PERCENT_OUTPUT);
        ...
        SetIntakeState m_deployIntakeReverse = new SetIntakeState(m_intake, m_actuators, "deploy reverse", 0.2);
        ...
        addCommands(new InstantCommand(() -> m_drivetrain.resetOdometry(m_initialPose)),
                    ...
                    new InstantCommand(() -> m_drivetrain.setGyro(-45.00))
                    );
