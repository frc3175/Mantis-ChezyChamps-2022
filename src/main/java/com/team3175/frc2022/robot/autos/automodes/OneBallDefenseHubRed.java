...
public class OneBallDefenseHubRed extends SequentialCommandGroup {
    ...
    public OneBallDefenseHubRed(Shooter shooter, Feeder feeder, Intake intake, Actuators actuators, SwerveDrivetrain drivetrain) {
        ...
        m_driveBack = PathPlanner.loadPath("1Ball-Defense-1-Hub-Red", Constants.AUTO_MAX_SPEED, Constants.AUTO_MAX_ACCELERATION_MPS_SQUARED);
