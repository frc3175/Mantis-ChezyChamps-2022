...
public class CornDogBlue extends SequentialCommandGroup {
    ...
    public CornDogBlue(Shooter shooter, Feeder feeder, Intake intake, Actuators actuators, SwerveDrivetrain drivetrain) {
        ...
        m_defensivePath = PathPlanner.loadPath("CornDog-1-Blue", Constants.AUTO_MAX_SPEED, Constants.AUTO_MAX_ACCELERATION_MPS_SQUARED);
        m_offensivePath = PathPlanner.loadPath("CornDog-2-Blue", Constants.AUTO_MAX_SPEED, Constants.AUTO_MAX_ACCELERATION_MPS_SQUARED);
