...
public class ThreeBallDERed extends SequentialCommandGroup {
    ...
    public ThreeBallDERed(Shooter shooter, Feeder feeder, Intake intake, Actuators actuators, SwerveDrivetrain drivetrain) {
        ...
        m_trajectory = PathPlanner.loadPath("3BallDE-1-Red", Constants.FOUR_BALL_MAX_SPEED, Constants.FOUR_BALL_MAX_ACCELERATION);
        m_trajectory2 = PathPlanner.loadPath("3BallDE-2-Red", Constants.AUTO_MAX_SPEED, Constants.AUTO_MAX_ACCELERATION_MPS_SQUARED);
        m_trajectory3 = PathPlanner.loadPath("3BallDE-3-Red", Constants.AUTO_MAX_SPEED, Constants.AUTO_MAX_ACCELERATION_MPS_SQUARED);
        m_trajectory4 = PathPlanner.loadPath("3BallDE-4-Red", Constants.FOUR_BALL_MAX_SPEED, Constants.FOUR_BALL_MAX_ACCELERATION);
