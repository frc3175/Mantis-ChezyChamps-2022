...
public class TwoBallADefenseHubRed extends SequentialCommandGroup {
    ...
    public TwoBallADefenseHubRed(Shooter shooter, Feeder feeder, Intake intake, Actuators actuators, SwerveDrivetrain drivetrain) {
        ...
        m_intakeA = PathPlanner.loadPath("2BallA-Defense-Hub-1-Red", Constants.AUTO_MAX_SPEED, Constants.AUTO_MAX_ACCELERATION_MPS_SQUARED);
        m_shootA = PathPlanner.loadPath("2BallA-Defense-Hub-2-Red", Constants.AUTO_MAX_SPEED, Constants.AUTO_MAX_ACCELERATION_MPS_SQUARED);
        m_intakeOpposite = PathPlanner.loadPath("2BallA-Defense-Hub-3-Red", Constants.AUTO_MAX_SPEED, Constants.AUTO_MAX_ACCELERATION_MPS_SQUARED);
        m_driveToHangar = PathPlanner.loadPath("2BallA-Defense-Hub-4-Red", Constants.AUTO_MAX_SPEED, Constants.AUTO_MAX_ACCELERATION_MPS_SQUARED);
